...
def process_isimip_data(gdir, output_filesuffix='', fpath_temp=None,
    ...
    **kwargs: any kwarg to be passed to ref:`process_gcm_data`
    ...
    if None in [fpath_temp, fpath_temp_h, fpath_temp_std, fpath_temp_std_h,
        ...
        if temporal_resol == 'monthly':
            if cluster:
                path = '/home/www/oggm/cmip6/isimip3b/flat/2023.2/monthly/'
            else:
                path = 'https://cluster.klima.uni-bremen.de/~oggm/cmip6/isimip3b/flat/2023.2/monthly/'
            add = '_global_monthly_flat_glaciers.nc'
        elif temporal_resol == 'daily':
            if cluster:
                path = '/home/www/oggm/cmip6/isimip3b/flat/2023.2/daily/'
            else:
                path = 'https://cluster.klima.uni-bremen.de/~oggm/cmip6/isimip3b/flat/2023.2/daily/'
